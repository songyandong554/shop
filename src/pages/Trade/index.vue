<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="a in address" :key="a.id">
        <span class="username" :class="{ selected: a.isDefault == 1 }">{{
          a.consignee
        }}</span>
        <p @click="changeDefault(a, address)">
...
export default {
  ...
  computed: {
    ...
    userAddressDefault() {
      return this.address.find((element) => element.isDefault == 1) || {};
    },
  },
  methods: {
    changeDefault(a, address) {

        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="g in spuSaleAttrList" :key="g.id">
                <dt class="title">{{ g.saleAttrName }}</dt>
                <dd
                  changepirce="0"
                  :class="{ active: change.isChecked == 1 }"
                  v-for="change in g.spuSaleAttrValueList"
                  :key="change.id"
                  @click="changeActive(change, g.spuSaleAttrValueList)"
                >
                  {{ change.saleAttrValueName }}
                </dd>
              </dl>
            </div>
            <div class="cartWrap">
